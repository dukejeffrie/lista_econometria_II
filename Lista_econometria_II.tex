...
\NormalTok{                            estado}\OperatorTok{-}\KeywordTok{lag}\NormalTok{(estado)}\OperatorTok{>}\DecValTok{4}\OperatorTok{~}\DecValTok{6}\NormalTok{,),}
                \DataTypeTok{diffV12_mult=}\KeywordTok{ifelse}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(diffV12_mult)}\OperatorTok{==}\NormalTok{T,}
...
\NormalTok{resultados }\OperatorTok{%>%}
\StringTok{  }\NormalTok{xtable}\OperatorTok{::}\KeywordTok{xtable}\NormalTok{(}\DataTypeTok{digits =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\KeywordTok{rep}\NormalTok{(}\DecValTok{3}\NormalTok{,}\KeywordTok{ncol}\NormalTok{(resultados))),}
                 \DataTypeTok{caption=}\StringTok{"Estimativas para o modelo modificado: }
\StringTok{                 Grid: 2.500, S: 180 e função custo logarítmica"}\NormalTok{,}
...
\begin{Highlighting}[]
\CommentTok{# Fonte:}
\CommentTok{# https://github.com/waynejtaylor/Single-Agent-Dynamic-Choice/blob/}
\CommentTok{# master/Import%20Data%20and%20Estimate.R}
...
\CommentTok{# Fonte:}
\CommentTok{# https://github.com/waynejtaylor/Single-Agent-Dynamic-Choice/}
\CommentTok{# blob/master/Rust%20Data%20Generating%20Process.R}
...
\StringTok{  3) Essa matriz é utilizada para computar a log-likelihood }
\StringTok{  das observações}
...
\StringTok{  blob/master/clogit.R}
...
\NormalTok{    j=}\DecValTok{1}
    ...
    \ControlFlowTok{while}\NormalTok{ (j}\OperatorTok{<=}\NormalTok{nchoice)\{}
      \CommentTok{#coluna de referência}
\NormalTok{      i_fu =}\StringTok{ }\NormalTok{i_fu }\OperatorTok{+}\StringTok{ }\NormalTok{pini[,j]}\OperatorTok{*}\NormalTok{fmat[,(numx}\OperatorTok{*}\NormalTok{(j}\DecValTok{-1}\NormalTok{)}\OperatorTok{+}\DecValTok{1}\NormalTok{)}\OperatorTok{:}\NormalTok{(numx}\OperatorTok{*}\NormalTok{j)] }
\NormalTok{      sumpz =}\StringTok{ }\NormalTok{sumpz }\OperatorTok{+}\StringTok{ }\NormalTok{pini[,j]}\OperatorTok{*}\NormalTok{zmat[,(npar}\OperatorTok{*}\NormalTok{(j}\DecValTok{-1}\NormalTok{)}\OperatorTok{+}\DecValTok{1}\NormalTok{)}\OperatorTok{:}\NormalTok{(npar}\OperatorTok{*}\NormalTok{j)]}
      \CommentTok{# Tratamento para o log}
\NormalTok{      sumpe =}\StringTok{ }\NormalTok{sumpe }\OperatorTok{+}\StringTok{ }\NormalTok{pini[,j]}\OperatorTok{*}\NormalTok{(eulerc }\OperatorTok{-}\StringTok{ }\KeywordTok{log}\NormalTok{(pini[,j]}\OperatorTok{+}\NormalTok{myzero))}
...
\NormalTok{    j=}\DecValTok{1}
    \ControlFlowTok{while}\NormalTok{(j}\OperatorTok{<=}\NormalTok{nchoice)\{}
\NormalTok{      ztilda[,(npar}\OperatorTok{*}\NormalTok{(j}\DecValTok{-1}\NormalTok{)}\OperatorTok{+}\DecValTok{1}\NormalTok{)}\OperatorTok{:}\NormalTok{(npar}\OperatorTok{*}\NormalTok{j)] =}
\StringTok{        }\NormalTok{zmat[,(npar}\OperatorTok{*}\NormalTok{(j}\DecValTok{-1}\NormalTok{)}\OperatorTok{+}\DecValTok{1}\NormalTok{)}\OperatorTok{:}\NormalTok{(npar}\OperatorTok{*}\NormalTok{j)]}\OperatorTok{+}
\StringTok{        }\NormalTok{bdisc}\OperatorTok{*}\NormalTok{fmat[,(numx}\OperatorTok{*}\NormalTok{(j}\DecValTok{-1}\NormalTok{)}\OperatorTok{+}\DecValTok{1}\NormalTok{)}\OperatorTok{:}\NormalTok{(numx}\OperatorTok{*}\NormalTok{j)]}\OperatorTok{%*%}\NormalTok{wz}
