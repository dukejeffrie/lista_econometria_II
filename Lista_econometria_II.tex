...
\CommentTok{# l_1 <- glm(troca~difV12-1,family = binomial(link = "logit"),}
\CommentTok{#            data = data)}
\CommentTok{# l_2 <- glm(difV12~lag(difV12)+lag(troca)-1,family = gaussian(link = "identity"),}
\CommentTok{#            data = data)}
